<%@ Page Title="" Language="C#" MasterPageFile="~/Client/Client.Master" AutoEventWireup="true" CodeBehind="property-detail.aspx.cs" Inherits="Ext_RealEstate.Client.property_detail" %>
                ...
                <div class="col-md-9 content">
                    ...
                    <section class="pgl-pro-detail pgl-bg-light">
                        ...
                        <div id="carousel" class="flexslider">
                            <ul class="slides">
                                <li>
                                    <img src="images/properties/property-detail-s-1.jpg" alt=""></li>
                                <li>
                                    <img src="images/properties/property-detail-s-2.jpg" alt=""></li>
                                <li>
                                    <img src="images/properties/property-detail-s-3.jpg" alt=""></li>
                                <li>
                                    <img src="images/properties/property-detail-s-4.jpg" alt=""></li>
                                <li>
                                    <img src="images/properties/property-detail-s-5.jpg" alt=""></li>
                                <li>
                                    <img src="images/properties/property-detail-s-1.jpg" alt=""></li>
                                <li>
                                    <img src="images/properties/property-detail-s-2.jpg" alt=""></li>
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <ul class="list-unstyled amenities amenities-detail">
                                        ...
                                        <li>
                                            <address><i class="icons icon-location"></i>Palo Alto, SA</address>
                                        </li>
