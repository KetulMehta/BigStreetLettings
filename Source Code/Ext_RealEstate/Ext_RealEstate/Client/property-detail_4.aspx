<%@ Page Title="" Language="C#" MasterPageFile="~/Client/Client.Master" AutoEventWireup="true" CodeBehind="property-detail_4.aspx.cs" Inherits="Ext_RealEstate.Client.property_detail_4" %>
                ...
                <div class="col-md-9 content">
                    ...
                    <section class="pgl-pro-detail pgl-bg-light">
                        <div id="slider" class="flexslider">
                            <ul class="slides">
                                <li>
                                    <img src="photo/h3.jpeg" height="625px" width="150px" />
                                ...
                                <li>
                                    <img src="photo/liv3.jpg" height="625px" width="150px" />
                                    <span class="property-thumb-info-label">
                                        <span class="label price">$344,000</span>
                                        <span class="label forrent">Rent</span>
                                    </span>
                        ...
                        <div id="carousel" class="flexslider">
                            <ul class="slides">
                                <li>
                                    <img src="photo/h3.jpeg" height="140px" width="50px" /></li>
                                <li>
                                    <img src="photo/k1.jpg" height="140px" width="50px" /></li>
                                <li>
                                    <img src="photo/liv3.jpg" height="140px" width="50px" /></li>
                                <li>
