<%@ Page Title="" Language="C#" MasterPageFile="~/Client/Client.Master" AutoEventWireup="true" CodeBehind="property-detail_3.aspx.cs" Inherits="Ext_RealEstate.Client.property_detail_3" %>
                ...
                <div class="col-md-9 content">
                    ...
                    <section class="pgl-pro-detail pgl-bg-light">
                        <div id="slider" class="flexslider">
                            <ul class="slides">
                                <li>
                                    <img src="photo/h5.jpg" height="625px" width="150px" />
                                ...
                                <li>
                                    <img src="photo/k5.jpg" height="625px" width="150px" />
                                    <span class="property-thumb-info-label">
                                        <span class="label price">$344,000</span>
                                    </span>
                                </li>
                                ...
                                <li>
                                    <img src="photo/b51.jpeg" height="625px" width="150px" />
                                    <span class="property-thumb-info-label">
                                        <span class="label price">$344,000</span>
                                    </span>
                                </li>
                        ...
                        <div id="carousel" class="flexslider">
                            <ul class="slides">
                                <li>
                                    <img src="photo/h5.jpg" height="140px" width="50px" /></li>
                                <li>
                                    <img src="photo/k5.jpg" height="140px" width="50px" /></li>
                                <li>
                                ...
                                <li>
                                    <img src="photo/b51.jpeg" height="140px" width="50px" /></li>
