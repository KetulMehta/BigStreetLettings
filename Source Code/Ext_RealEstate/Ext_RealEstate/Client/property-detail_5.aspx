<%@ Page Title="" Language="C#" MasterPageFile="~/Client/Client.Master" AutoEventWireup="true" CodeBehind="property-detail_5.aspx.cs" Inherits="Ext_RealEstate.Client.property_detail_5" %>
                ...
                <div class="col-md-9 content">
                    ...
                    <section class="pgl-pro-detail pgl-bg-light">
                        <div id="slider" class="flexslider">
                            <ul class="slides">
                                <li>
                                    <img src="photo/h4.jpg" height="625px" width="150px" />
                                    <span class="property-thumb-info-label">
                                        <span class="label price">$344,000</span>
                                        <span class="label forrent">Rent</span>
                                    </span>
                                </li>
                                <li>
                                     <img src="photo/k4.jpg" height="625px" width="150px" />
                                    <span class="property-thumb-info-label">
                                        <span class="label price">$344,000</span>
                                    </span>
                                </li>
                                ...
                                <li>
                                    <img src="photo/living1.jpg" height="625px" width="150px" />
                                    <span class="property-thumb-info-label">
                                        <span class="label price">$344,000</span>
                                    </span>
                                </li>
                                <li>
                                    <img src="photo/bath4.jpg" height="625px" width="150px" />
                                    <span class="property-thumb-info-label">
                                        <span class="label price">$344,000</span>
                                    </span>
                                </li>
                                ...
                                <li>
                                    <img src="photo/b5.jpg" height="625px" width="150px" />
                                    <span class="property-thumb-info-label">
                                        <span class="label price">$344,000</span>
                                    </span>
                                </li>
                                <li>
                                    <img src="photo/bath5.jpg" height="625px" width="150px" />
                                    <span class="property-thumb-info-label">
                                        <span class="label price">$344,000</span>
                                        <span class="label forrent">Rent</span>
                                    </span>
                        ...
                        <div id="carousel" class="flexslider">
                            <ul class="slides">
                                <li>
                                    <img src="photo/h4.jpg" height="140px" width="50px" /></li>
                                <li>
                                <img src="photo/k4.jpg" height="140px" width="50px" /></li>
                               
                                <li>
                                    <img src="photo/bed4.jpeg" height="140px" width="50px" /></li>
                                <li>
                                    <img src="photo/living1.jpg" height="140px" width="50px" /></li>
                                <li>
                                <img src="photo/bath4.jpg" height="140px" width="50px" /></li>
                                
                                <li>
                                    <img src="photo/k2.jpg" height="140px" width="50px" /></li>
                                <li>
                                    <img src="photo/b5.jpg" height="140px" width="50px" /></li>
                                <li>
                                <img src="photo/bath5.jpg" height="140px" width="50px" /></li>
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <ul class="list-unstyled amenities amenities-detail">
                                        ...
                                        <li><strong>Area:</strong> 400<sup>m2</sup></li>
                                        <li>
                                            <address>
                                                <i class="icons icon-location"></i>
                                            41,Los Angeles</address>
                                        </li>
